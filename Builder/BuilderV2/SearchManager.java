...
public class SearchManager extends JFrame {
    ...
    public static final String COMPANY_SRCH = "Company SQL Statement";
    ...
    public SearchManager() throws Exception {
        ...
        cmbSearchType.addItem(SearchManager.COMPANY_SRCH);
...
class BuilderFactory {
    public UIBuilder getUIBuilder(String str) {
        ...
        } else if (str.equals(SearchManager.COMPANY_SRCH)) {
            builder = new CompSrchBuilder();
        }
        return builder;
    }
}
